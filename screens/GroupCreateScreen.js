...
export default function GroupCreateScreen({ navigation, route }) {
  ...
  const [teamSelectType, setTeamSelectType] = useState('');
  ...
  const handleContinue = () => {
    ...
    if (!teamSelectType) {
      alert('Takım seçme türünü belirtmelisiniz!');
      return;
    }
    const tournament = {
      tournamentName,
    ...
    // Artık TeamAdd yerine GroupSetup ekranına yönlendiriyoruz!
  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <Text style={styles.modesInfo}>
          Puan Durumu: Kazanan 3 puan, Berabere 1 puan, Kaybeden 0 puan alır.
        </Text>

        {/* Sıralama Önceliği Bilgisi */}
        <View style={styles.orderBox}>
          <Text style={styles.orderTitle}>
            Sıralama Önceliği (Sürükleyip bırak veya oklarla değiştir)
          </Text>
          <DraggableFlatList
            data={orderRules}
        ...
        <View style={styles.teamSelectContainer}>
          <TouchableOpacity
            style={[
              ...
              teamSelectType === 'RASTGELE' && styles.teamSelectButtonSelected,
            ]}
          ...
          <TouchableOpacity
            style={[
              styles.teamSelectButton,
              teamSelectType === 'MANUEL' && styles.teamSelectButtonSelected,
            ]}
        ...
        <TouchableOpacity
          style={[
            styles.createButton,
            (!groupName.trim() || !matchType || !teamSelectType) && styles.createButtonDisabled,
          ]}
          onPress={handleContinue}
          disabled={!groupName.trim() || !matchType || !teamSelectType}
        >
          <Text
            style={[
              styles.createButtonText,
              (!groupName.trim() || !matchType || !teamSelectType) && styles.createButtonTextDisabled,
            ]}
          >
            Devam
            </Text>
